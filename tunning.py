...
#                     res.append(((acc.acc, acc.recall, acc.f1),(opts.Dw, opts.lamb, opts.lamb0, opts.eta, opts.mu)))
#                     torch.save(res, 'tunning.pt')
"Dw=29, lamb=0.1, lamb_ratio=0.1, eta=0.01, mu=0.1"
"Dw=21, lamb=0.1, lamb_ratio=1, eta=0.001, mu=1"
"Dw=21, lamb=0.1, lamb_ratio=0.1, eta=0.001, mu=1"
...
#                         res.append(((acc.acc, acc.recall, acc.f1),(opts.Dw, opts.lamb, opts.lamb0, opts.eta, opts.mu)))
#                         torch.save(res, 'tunning.pt')
"Dw=29, lamb=0.1, lamb_ratio=0.1, eta=0.001, mu=0.1 is the best" 
